  ...
  return (
    <nav className="flex items-center justify-between bg-blue-600 p-6">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-end justify-end lg:w-auto">
        <div>
          <a href="https://github.com/thepearson/palette-pal" className="inline-flex items-center text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-blue-600 hover:bg-white lg:mt-0"><FaGithub className="mr-2" /> Github</a>
        </div>
      </div>
    </nav>);
}
